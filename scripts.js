...
words_codeNamesDuo = [ 'OASIS', 'VODKA', 'CRIQUET', 'CHÈVRE', 'MOMIE', 'LOUP', 'PONT', 'POINTE', 'TRONC', 'PORTUGAL', 'SERVICE', 'VIKING',
						...
						'AMÉRICAIN', 'DOIGT', 'PERROQUET', 'NUAGE', 'VOEU', 'BONSAÏ', 'ÉPAULE', 'FRANCHISE', 'FORME', 'RAIL', 'RÂTEAU', 'POUPÉE', 'POIS', 'GORILLE',
						'CRAVATE', 'FOOTBALL', 'SANG', 'COUTURE', 'DESSIN', 'RIZ', 'ROUAGE', 'CHANTEUR', 'VOYAGE', 'PORC', 'DIVISION', 'ALLEMAND', 'OUVERTURE', 
						'DROGUE', 'BATTERIE', 'VESTE', 'SUITE', 'FILM', 'TARTE', 'BÉBÉ', 'TÉLÉSCOPE', 'RÈGLEMENT', 'DIMANCHE', 'CASQUE', 'MINUIT', 'LIBERTÉ', 
						'SUJET', 'ÉPOUVANTAIL', 'CAMÉLÉON', 'KILT', 'POUDRE', 'MUR', 'ÉPICE', 'DISQUE', 'ÉLÉPHANT', 'FOURMI', 'ALASKA', 'SKI', 'AGENT',
						'MATIÈRE', 'MARATHON', 'EMPEREUR', 'SPHINX', 'SIGNE', 'AVENTURE', 'MARACASSE', 'MASSE', 'POP-CORN', 'GOURDE', 'TONNERRE', 'ÉCLAT',
						'CULTURE', 'POSITION', 'FRATERNITÉ', 'SABLE', 'PATATE', 'STATION', 'BOUE', 'CIRE', 'ÉLECTRCITÉ', 'MARIAGE', 'COW-BOY', 'FÉE', 'CIMETIÈRE',
						'CAVALIER', 'ATLANTIDE', 'RHUM', 'MAMMOUTH', 'PYTHON', 'TUYAU', 'NYLON', 'RENCONTRE', 'SOCIÉTÉ', 'MÉDUSE', 'ABEILLE', 'TIPI', 'DOUBLE',
						'BANDEAU', 'DIABLE', 'UNION', 'COQUILLE', 'AFFAIRE', 'MORCEAU','FENÊTRE', 'BACON', 'ODEUR', 'SAHARA', 'OMBRE', 'ÉLAN', 'BULLE', 'CHÂTAIGNE',
						'FAILLE', 'DIRECTEUR', 'ESQUIMAU', 'SOLDE', 'TÉMOIN', 'TROIS', 'PÂQUES', 'ASTRONAUTE', 'TRIBUNE', 'JAPON', 'LOUVRE', 'SAMOURAÏ', 'GOÛT', 'TIGRE',
						'CLOWN', 'LAPIN', 'BARCELONE', 'MERCURE', 'BLANC', 'NERF', 'BEURRE', 'ACIER', 'TRAIN', 'BARRIÈRE', 'ROND', 'MENTHE', 'PUB', 'BAISER', 'FÈVE',
						'SEL', 'SAN FRANCISCO', 'BAGUE', 'KARATÉ', 'CHAUSSETTE', 'SUISSE', 'PAIX', 'VARIÉTÉ', 'VACHE', 'CHAUFFEUR', 'PLOMB', 'CACHUÈTE', 'CÉSAR', 'ÉPÉE',
						'CREVETTE', 'MOUTARDE', 'MENSONGE', 'POKER', 'CONCERT', 'BIEN', 'BASSIN', 'PAPILLON', 'DOSSIER', 'INDEX', 'BOSSE', 'POLONAIS', 'PISTE', 'LACET',
						'BARBE', 'JOKER', 'NOYAU', 'PARADE', 'CROISSANT', 'SECONDE', 'LAINE', 'INSTRUMENT', 'MUGUET', 'HAWAÏ', 'CÔTE', 'POUSSIN', 'BARBECUE', 'JARDIN',
						'MILIEU', 'FRANKENSTEIN', 'OURAGAN', 'NOMBRIL', 'DAME', 'DAUPHIN', 'PEINTURE', 'LUNETTE', 'AMBULANCE', 'MAIRIE', 'CORBEAU', 'PRÉSIDENT', 'CANAPÉ',
						'MILITAIRE', 'SINGE', 'CORPS', 'FONTAINE', 'URBAIN', 'ANTARCTIQUE', 'MALADE', 'RACINE', 'HALLOWEEN', 'TINTIN', 'TUNNEL', 'BRISE', 'RÉPLIQUE', 'PIC',
						'CRÊTE', 'PASSAGE', 'PIEUVRE', 'CAROTTE', 'MORSE', 'MOTIF', 'NID', 'CRABE', 'MOTEUR', 'BATAILLE', 'COUSIN', 'NIL', 'PARABOLE', 'PUCE', 'BROADWAY',
						'PRESSE', 'FUMÉE', "ZOMBIE", 'PLONGEUR', 'BARREAU', 'CHICAGO', 'BEETHOVEN', 'PRUNE', "SECRÉTAIRE", 'RENAISSANCE', 'CHINOIS', 'CASSEROLE', 'VOIX',
...
function help(){
	...
	for (key in colorsHelpDict){
		...
		cellbutton.setAttribute("width","115px")
		cellbutton.appendChild(button);
		var celltext = row.insertCell(-1);
		celltext.innerText = colorsHelpDict[key];
		i++;
	}
}
...
function initGamePlayer0(){
	...
	words_25 = getRandomSubarray(words_codeNamesDuo,25);
